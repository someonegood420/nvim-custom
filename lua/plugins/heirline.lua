return {
  ...
  config = function()
    ...
    -- Ensure the whole statusline is transparent
    vim.api.nvim_set_hl(0, "StatusLine", { bg = "none", fg = colors.fg })
    vim.api.nvim_set_hl(0, "StatusLineNC", { bg = "none", fg = colors.fg })
    ...
    local ViMode = {
      {
        ...
        hl = function()
          return {
            bg = colors.bg,
            fg = get_mode_color(), -- solid dark text on bright mode color
            bold = true,
          }
        end,
      },
