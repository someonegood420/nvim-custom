return {
...

  {
    ...
    config = function()
          ...
          sections = {
            {
              ...
              section = "terminal",
              cmd =
              'img2art "C:/Users/ahad/AppData/Local/nvim/lua/plugins/dashboardgirl.jpg" --scale 0.37 --with-color --threshold 50',
              height = 51,
              width = 120,
            },
            { pane = 2, section = "keys" },
      ...
      -- #Git
      map("<leader>gg", function() Snacks.lazygit({ cwd = vim.fn.fnamemodify(vim.fn.finddir(".git", ".;"), ":h") }) end,
        "Lazygit")
